...
public class TextureProvider {
    ...
    private static final Identifier PLAYER_TEXTURE = Identifier.of(Arkanoid.MOD_ID, "textures/gui/game/player.png");
    private static final Identifier PLAYER_EXTRA_TEXTURE = Identifier.of(Arkanoid.MOD_ID, "textures/gui/game/extra.png");
