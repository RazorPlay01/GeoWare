package com.github.razorplay01.geowaremod.games.donkeykong.game.entity;
...
import static com.github.razorplay01.geowaremod.games.donkeykong.game.util.TextureProvider.FIRE_L_TEXTURES;
import static com.github.razorplay01.geowaremod.games.donkeykong.game.util.TextureProvider.FIRE_R_TEXTURES;
import static com.github.razorplay01.razorplayapi.util.ScreenSide.verifyScreenBoundsCollision;


@Getter
public class Fire extends DonkeyKongEntity {
...
// Hitbox más alta para las escaleras para poder engancharse mejor
        this.hitboxes.add(new RectangleHitbox(HITBOX_LADDER, xPos, yPos, 16, 16, 0, 0, LADDER_HITBOX_COLOR));
        this.hitboxes.add(new RectangleHitbox(HITBOX_PLAYER, xPos + 4, yPos + 4, 8, 8, 4, 4, PLAYER_HITBOX_COLOR));
    }
...
// Verificar si debemos salir de la escalera
    ...
    private boolean isCollidingWithPlatform(Platform platform) {
        ...
        RectangleHitbox fireHitbox = (RectangleHitbox) this.getDefaultHitbox();
        ...
        return fireHitbox.intersects(platformHitbox) &&
                Math.abs((fireHitbox.getYPos() + fireHitbox.getHeight()) - platformHitbox.getYPos()) <= Math.abs(velocityY);
    }
