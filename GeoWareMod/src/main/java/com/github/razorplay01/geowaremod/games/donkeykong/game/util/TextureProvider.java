package com.github.razorplay01.geowaremod.games.donkeykong.game.util;
...
public class TextureProvider {
    ...
    private static final Identifier BARREL_TEXTURE = Identifier.of(GeoWareMod.MOD_ID, "textures/gui/game/barrel.png");
    ...
    private static final Identifier FIRE_TEXTURE = Identifier.of(GeoWareMod.MOD_ID, "textures/gui/game/fire.png");
    ...
    private static final Identifier PARTICLE_TEXTURE = Identifier.of(GeoWareMod.MOD_ID, "textures/gui/game/pop_particle.png");
