package com.github.razorplay01.geowaremod.games.donkeykong.game.mapobject;

import com.github.razorplay01.geowaremod.GeoWareMod;
import com.github.razorplay01.geowaremod.games.donkeykong.DonkeyKongGame;
...
public class Ladder extends MapObject {
    ...
    public Ladder(GameScreen gameScreen, float xPos, float yPos, float width, float height, boolean canPassThroughPlatform) {
        super(xPos, yPos, width, height, 0xAA00ffec, gameScreen);
    ...
    public void render(DrawContext context) {
        ...
        for (int segmentY = 0; segmentY < this.getHeight(); segmentY += segmentHeight) {
            ...
            for (Platform platform : ((DonkeyKongGame) getScreen().getGame()).getPlatforms()) {
