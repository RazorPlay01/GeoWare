...
public class TetrominoZ extends Tetromino {
    ...
    protected void initializeBlocks() {
        ...
        blocks[0] = new TetrominoBlock(0, 0, 0xFFFF0000); // Rojo
        blocks[1] = new TetrominoBlock(1, 0, 0xFFFF0000);
        blocks[2] = new TetrominoBlock(0, 1, 0xFFFF0000);
        blocks[3] = new TetrominoBlock(-1, 1, 0xFFFF0000);
    }
}
