...
public class TetrominoI extends Tetromino {
    ...
    protected void initializeBlocks() {
        ...
        blocks[0] = new TetrominoBlock(-1, 0, 0xFF00FFFF); // Cyan
        blocks[1] = new TetrominoBlock(0, 0, 0xFF00FFFF);
        blocks[2] = new TetrominoBlock(1, 0, 0xFF00FFFF);
        blocks[3] = new TetrominoBlock(2, 0, 0xFF00FFFF);
    }
}